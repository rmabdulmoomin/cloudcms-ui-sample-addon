define(function (require, exports, module) {
    ...
    $.alpaca.Fields.CustomField = Alpaca.Fields.SelectField.extend({
        getFieldType: function() {
            return "custom-multiselect-check-box";
        },
        onChange: function (data) {
            ...
            console.log(" **** getFieldEl", self.getFieldEl());
            if(!self.getValue()){
                self.setDefault();
            }
    ...
    Alpaca.registerFieldClass("custom-multiselect-check-box", Alpaca.Fields.CustomField);
